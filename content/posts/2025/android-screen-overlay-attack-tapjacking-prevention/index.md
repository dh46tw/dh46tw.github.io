...
今年度的資安檢測基準新增了「螢幕覆蓋攻擊」的檢測項目。接下來手上的專案都會受影響，因此特別寫下這篇筆記，幫自己快速釐清概念、方法與實作方式。
...
以上是我在 Android 上處理螢幕覆蓋攻擊的整理與實作心得。
如果你最近也在面對相同的資安檢測項目，希望這篇文章能幫你省下一些摸索時間。如果內容有不足或更好的作法，也非常歡迎留言交流。
